                ...
                <div style="padding: 40px;">
                    ...
                    <form method="POST" style="display: grid; gap: 25px;">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            <div>
                                <label style="display: block; margin-bottom: 8px; font-weight: 600; color: var(--business-dark); text-transform: uppercase; font-size: 12px; letter-spacing: 0.5px;">Username *</label>
                                <input type="text" name="username" class="business-input" required>
                            </div>
                            <div>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            <div>
                                <label style="display: block; margin-bottom: 8px; font-weight: 600; color: var(--business-dark); text-transform: uppercase; font-size: 12px; letter-spacing: 0.5px;">Student ID *</label>
                                <input type="text" name="student_id" class="business-input" placeholder="BUS-2024-001" required>
                            </div>
                            <div>
