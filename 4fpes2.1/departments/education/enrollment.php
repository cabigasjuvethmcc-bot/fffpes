...
// Get students in Education department ONLY
try {
...
<head>
    ...
    <title>Education Department - Student Enrollment</title>
    ...
    <style>
        ...
        .education-dashboard { background: #f5f7fb; padding: 24px; }
        .education-header { background: #ffffff; box-shadow: 0 10px 24px rgba(0,0,0,0.06); border-radius: 20px; }
        .education-card { background: #ffffff; box-shadow: 0 10px 24px rgba(0,0,0,0.06); border-radius: 16px; }
        .education-table-header { padding: 24px; }
...
<body>
    ...
    <div class="education-dashboard">
        <div class="dashboard-container" style="max-width: 1400px; margin: 0 auto; padding: 20px;">
            ...
            <div class="education-header education-animate" style="position: relative; overflow: hidden;">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <div style="display: flex; align-items: center; gap: 20px;">
                        ...
                        <div>
                            <h1 style="margin: 0; font-size: 2.5rem; font-weight: 700;">Education Department</h1>
                            <p style="margin: 5px 0 0 0; opacity: 0.9; font-size: 1.1rem;">Academic Excellence & Student Enrollment</p>
                        </div>
                    </div>
            ...
            <!-- Enrollment Form -->
            <div class="education-card education-animate" style="margin-bottom: 30px;">
                <div style="padding: 40px;">
                    <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 30px;">
                        <div class="education-icon" style="width: 50px; height: 50px; font-size: 20px;">
                            <i class="fas fa-user-graduate"></i>
                        </div>
                        <h2 style="margin: 0; color: var(--education-primary); font-size: 1.8rem;">Enroll New Education Student</h2>
                    </div>
                    ...
                    <form method="POST" style="display: grid; gap: 25px;">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            <div>
                                <label style="display: block; margin-bottom: 8px; font-weight: 600; color: var(--education-dark);">Username *</label>
                                <input type="text" name="username" class="education-input" required>
                            </div>
                            <div>
                                <label style="display: block; margin-bottom: 8px; font-weight: 600; color: var(--education-dark);">Password *</label>
                                <input type="password" name="password" class="education-input" required>
                            </div>
                        </div>

                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            <div>
                                <label style="display: block; margin-bottom: 8px; font-weight: 600; color: var(--education-dark);">Full Name *</label>
                                <input type="text" name="full_name" class="education-input" required>
                            </div>
                            <div>
                                <label style="display: block; margin-bottom: 8px; font-weight: 600; color: var(--education-dark);">Email</label>
                                <input type="email" name="email" class="education-input">
                            </div>
                        </div>

                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            <div>
                                <label style="display: block; margin-bottom: 8px; font-weight: 600; color: var(--education-dark);">Student ID *</label>
                                <input type="text" name="student_id" class="education-input" placeholder="EDU-2024-001" required>
                            </div>
                            <div>
                                <label style="display: block; margin-bottom: 8px; font-weight: 600; color: var(--education-dark);">Year Level</label>
                                <select name="year_level" class="education-input">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            ...
                            <div>
                                <label style="display: block; margin-bottom: 8px; font-weight: 600; color: var(--education-dark);">Assigned Faculty (Multiple)</label>
                                <select name="assigned_faculty_user_ids[]" id="faculty_select" class="education-input" multiple size="5"></select>
                                <small style="color:#6b7280;">Hold Ctrl/Cmd to select multiple faculty.</small>
                            </div>
                        </div>

                        <div>
                            <label style="display: block; margin-bottom: 8px; font-weight: 600; color: var(--education-dark);">Education Program</label>
                            <select name="program" class="education-input">
                        ...
                        <div id="faculty-subjects-container" class="education-card" style="padding:16px; display:none;">
                            <h3 style="margin-top:0; color: var(--education-dark);">Select Subjects per Faculty</h3>
                        ...
                        <button type="submit" class="education-btn" style="justify-self: start; font-size: 16px;">
            ...
            <div class="education-card education-animate">
                <div class="education-table-header" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>
                        <h3 style="margin: 0; font-size: 1.5rem;">Education Department Students</h3>
                ...
                <?php if (empty($students)): ?>
                    <div style="padding: 60px; text-align: center; color: #666;">
                        ...
                        <h3 style="color: var(--education-primary); margin-bottom: 10px;">No Students Enrolled Yet</h3>
                        <p>Begin your educational journey by enrolling your first student above.</p>
                    </div>
                <?php else: ?>
    ...
    <script>
        // Dynamic faculty loading for Education page
