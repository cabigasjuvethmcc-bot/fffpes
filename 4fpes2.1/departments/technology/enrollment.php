            ...
            <div class="tech-card tech-animate" style="margin-bottom: 30px;">
                <div style="padding: 40px;">
                    ...
                    <form method="POST" style="display: grid; gap: 25px;">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            <div>
                                <label style="display: block; margin-bottom: 8px; font-weight: 600; color: var(--tech-dark);">Student ID *</label>
                                <input type="text" name="student_id" class="tech-input" placeholder="TECH-2024-001" required>
                            </div>
                            <div>
